...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Asset.eth0_mac'
        db.delete_column('invdb_asset', 'eth0_mac')

        # Deleting field 'Asset.eth0_vlan'
        db.delete_column('invdb_asset', 'eth0_vlan')

        # Deleting field 'Asset.eth0_ip'
        db.delete_column('invdb_asset', 'eth0_ip')


    def backwards(self, orm):
        # Adding field 'Asset.eth0_mac'
        db.add_column('invdb_asset', 'eth0_mac',
                      self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=12, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Asset.eth0_vlan'
        db.add_column('invdb_asset', 'eth0_vlan',
                      self.gf('django.db.models.fields.IntegerField')(default='0', max_length=4, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Asset.eth0_ip'
        db.add_column('invdb_asset', 'eth0_ip',
                      self.gf('django.db.models.fields.IPAddressField')(default=None, unique=True, max_length=15, null=True, blank=True),
                      keep_default=False)
