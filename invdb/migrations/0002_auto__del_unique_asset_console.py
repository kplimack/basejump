...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Asset', fields ['console']
        db.delete_unique('invdb_asset', ['console'])


    def backwards(self, orm):
        # Adding unique constraint on 'Asset', fields ['console']
        db.create_unique('invdb_asset', ['console'])
