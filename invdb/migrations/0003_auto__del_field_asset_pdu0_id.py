...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Asset.pdu0_id'
        db.delete_column('invdb_asset', 'pdu0_id_id')


    def backwards(self, orm):
        # Adding field 'Asset.pdu0_id'
        db.add_column('invdb_asset', 'pdu0_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['invdb.Asset'], null=True, blank=True),
                      keep_default=False)
